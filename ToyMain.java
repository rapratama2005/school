...
public class ToyMain //remember to change this
{
   ...
   //main function
    public static void main(String[] args) throws FileNotFoundException
    {
      ...
      while(!isSame){//while loop
         Toy t1 = new Toy();//new obj
         Toy t2 = new Toy();
         System.out.println(t1);//output obj
         System.out.println(t2);
         System.out.println();
         isSame = t1.equals(t2);//checks to continue
      }
