...
public class CaesarCipherMain //remember to change this
{
   ...
   public static int binarySearch (ArrayList<Integer> list, int target){//binary search - searches from middle
    ...
    public static void main(String[] args) throws FileNotFoundException //main function
    {
      ...
      System.out.print("Enter shift: ");//shift
      CaesarCipher cipher = new CaesarCipher(input.nextInt());
      input.nextLine();

      System.out.print("\nEnter word 1: ");//word 1
      System.out.println("encrypted word: " + cipher.encrypt(input.nextLine())); 
