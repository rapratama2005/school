...
public class VenmoAccountMain //remember to change this
{
   ...
   public static int binarySearch (ArrayList<Integer> list, int target){//binary search - searches from middle
    ...
    public static void main(String[] args) throws FileNotFoundException //main function
    {
      ...
      System.out.print("Enter ID 1: ");//account 1
      String ID = input.nextLine();
      System.out.print("Enter balance: ");
      int bal = input.nextInt();
      input.nextLine();
      VenmoAccount a1 = new VenmoAccount(ID, bal);

      System.out.print("Enter ID 2: ");//account 2
      ID = input.nextLine();
      System.out.print("Enter balance: ");
      bal = input.nextInt();
      input.nextLine();
      VenmoAccount a2 = new VenmoAccount(ID, bal);

      System.out.printf("\nCurrent balances:\n%s\n%s\n\n", a1, a2);//before
      
      System.out.print("Enter amount to transfer: ");//transfer
      a1.transfer(a2, input.nextInt());
