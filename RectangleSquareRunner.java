...
public class RectangleSquareRunner //remember to change this
{
   ...
   //main function
    public static void main(String[] args) throws FileNotFoundException
    {
      ...
      print("Enter width: ");//input
      int width = input.nextInt();
      print("Enter height: ");
      int height = input.nextInt();
      println(" ");
      if (width == height){//checks for sqaure
         Square shape = new Square(width);//square
         System.out.println(shape);
      } else {
         Rectangle shape = new Rectangle(width, height);//not square
         System.out.println(shape);
      }
