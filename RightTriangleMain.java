...
public class RightTriangleMain //remember to change this
{
   ...
   public static int binarySearch (ArrayList<Integer> list, int target){//binary search - searches from middle
    ...
    public static void main(String[] args) throws FileNotFoundException //main function
    {
      ...
      System.out.print("Enter triangle 1 base: ");//input
      int base1 = input.nextInt();
      System.out.print("Enter triangle 1 height: ");
      int height1 = input.nextInt();
      System.out.print("Enter triangle 2 base: ");
      int base2 = input.nextInt();
      System.out.print("Enter triangle 2 height: ");
      int height2 = input.nextInt();

      RightTriangle t1 = new RightTriangle(base1, height1);//triangles
      RightTriangle t2 = new RightTriangle(base2, height2);

      System.out.printf("\nTriangle 1 area: \n%.1f", t1.getArea());//prints areas
      System.out.printf("\nTriangle 2 area: \n%.1f\n\n", t2.getArea());

      if (t1.isLarger(t2)){//compares
         System.out.println("Triangle 1 is larger");
      } else if (t2.isLarger(t1)){
