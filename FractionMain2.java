...
public class FractionMain2 //remember to change this
{
   ...
   public static int binarySearch (ArrayList<Integer> list, int target){//binary search - searches from middle
    ...
    public static void main(String[] args) throws FileNotFoundException //main function
    {
      ...
      System.out.print("Enter add, subtract or multiply: ");//input
      String operation = (input.nextLine().substring(0,1).toLowerCase());
      ...
      Fraction f1 = new Fraction(numerator1, denominator1);//creates fractions
      Fraction f2 = new Fraction(numerator2, denominator2);

      System.out.printf("\nFraction 1: \n%s\n", f1);//prints fraction
      System.out.printf("Fraction 2: \n%s\n", f2);

      if (operation.equals("a")){//checks to add/multiplie/subtract
         f1.addFraction(f2);
