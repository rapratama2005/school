...
public class PointCircleMain //remember to change this
{
   ...
   //main function
    public static void main(String[] args) throws FileNotFoundException
    {
      ...
      print("Enter circle center x: ");
      double x = input.nextDouble();
      print("Enter circle center y: ");
      ...
      //area and circumfrenec
      System.out.printf("\ncircle area: %f\ncircle circumference: %f\n\n", circle.area(), circle.circumfrence());
      
      print("Enter circle center x: ");//new point
      x = input.nextDouble();
      print("Enter circle center y: ");
      y = input.nextDouble();
      ...
      if (circle.contains(point)){//checks if point in circle
