...
public class StudentWorkerRunner //remember to change this
{
   ...
   //main function
    public static void main(String[] args) throws FileNotFoundException
    {
      ...
      print("Enter student or worker: ");
      String studentOrWorker = input.nextLine();
      print("Enter name: ");
      String name = input.nextLine();
      print("Enter age: ");
      int age = input.nextInt();
      if (studentOrWorker.substring(0, 1).toLowerCase().equals("s")){//if is student
         print("Enter grade: ");
         int grade = input.nextInt();
         print("Enter gpa: ");
         double gpa = input.nextDouble();
         Student person = new Student(name, age, grade, gpa);

         System.out.printf("\n%s is %d years old\n", person.getName(), person.getAge());
         System.out.printf("%s is in grade %d\n", person.getName(), person.getGrade());
         System.out.printf("%s's gpa is %.1f\n", person.getName(), person.getGpa());
      } else {//if worker
         print("Enter title: ");
         input.nextLine();
         ...
         Worker person = new Worker(name, age, title, salary);

         System.out.printf("\n%s is %d years old\n", person.getName(), person.getAge());
         System.out.printf("%s is a %s and makes $%d\n", person.getName(), person.getTitle(), person.getSalary());
      }
