...
public class PersonMain //remember to change this
{
   ...
   //main function
    ...
    {
      String[] name = {"Alice","Bob"};//secret person
      Person p1 = new Person(name[randomInt(0,1)],randomInt(16,17));
      //input
      Scanner input = new Scanner(System.in);//imports scanner
      print("Enter Alice or Bob: ");
      String guessName = input.nextLine();
      print("Enter 16 or 17: ");
      int guessAge = input.nextInt();
      Person p2 = new Person(guessName, guessAge);

      //output
      System.out.println("\nSecret Person Description: \n" + p1);
      if(p1.equals(p2)){
         println("Correct");
      } else {
         println("Incorrect");
